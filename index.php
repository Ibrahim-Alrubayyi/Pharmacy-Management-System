...
<head>
    ...
    <script src="https://kit.fontawesome.com/d9294f6237.js" crossorigin="anonymous"></script>
...
?>
    ...
    <!--------------------------------- Main section -------------------------------->
    <section class="main" style="    margin-left: 268px;">
        <div class="container">
...
$query         = "SELECT COUNT(*) totalSalesman FROM salesmans;";
    ...
    ?>
                <div class="allManager">
                    <div class="main__table" style="margin: 0;">
                        <table class="table">
                            <thead>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <center><img class="rounded-circle" width="40" height="40"
                                                src="assets/img/<?php echo $manager['avatar']; ?>" alt=""></center>
                                    </td>
                                    <td><?php printf("%s %s", $manager['fname'], $manager['lname']);?></td>
                                    <td><?php printf("%s", $manager['email']);?></td>
                                    <td><?php printf("%s", $manager['phone']);?></td>
                                    <td><?php printf("%s", clucDate($manager['age']));?></td>
                                    <td><?php printf("%s", $manager['date_of_employment']);?></td>
                                    <td><?php printf("%s", $manager['salary']);?></td>
                                    <td><?php printf("%s", $manager['id_number']);?></td>
                                    <?php if ('admin' == $sessionRole) {?>
                                    <!-- Only For Admin -->
                                    <td><?php printf("<a href='index.php?action=editManager&id=%s'><i class='fas fa-edit'></i></a>", $manager['id'])?>
                                    </td>
                                    <td><?php printf("<a class='delete' href='index.php?action=deleteManager&id=%s'><i class='fas fa-trash'></i></a>", $manager['id'])?>
                                    </td>
                                    <?php }?>
                                </tr>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <span style="font-weight: bold;margin-left: 5px; color:#4e73df">Age</span>
                                        <input type="date" name="age" placeholder="Age" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        <span style="font-weight: bold;margin-left: 5px;color:#4e73df">date of
                                            employment</span>
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <i id="left" class="fa fa-regular fa-money-bill-1"></i>
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <i id="left" class="fa-solid fa-id-card"></i>
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="text" name="fname" placeholder="First name"
                                            value="<?php echo $manager['fname']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="text" name="lname" placeholder="Last Name"
                                            value="<?php echo $manager['lname']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="email" name="email" placeholder="Email"
                                            value="<?php echo $manager['email']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="number" name="phone" placeholder="Phone"
                                            value="<?php echo $manager['phone']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="date" name="age" placeholder="Age"
                                            value="<?php echo $manager['age']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="date" name="date_of_employment" placeholder="date of employment"
                                            value="<?php echo $manager['date_of_employment']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="number" name="salary" placeholder="Salary"
                                            value="<?php echo $manager['salary']; ?>" required>
                                    </label>
                                </div>
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="number" name="id_number" placeholder="ID Number"
                                            value="<?php echo $manager['id_number']; ?>" required>
                                    </label>
                                </div>
...
$getPharmacist = "SELECT * FROM pharmacists";
    ...
    while ($pharmacist = mysqli_fetch_assoc($result)) {?>
                                ...
                                <tr>
                                    ...
                                    <td><?php printf("%s", clucDate($pharmacist['age']));?></td>
                                    <td><?php printf("%s", $pharmacist['date_of_employment']);?></td>
                                    <td><?php printf("%s", $pharmacist['salary']);?></td>
                                    <td><?php printf("%s", $pharmacist['id_number']);?></td>
                                    <?php if ('admin' == $sessionRole || 'manager' == $sessionRole) {?>
                                    <!-- For Admin, Manager -->
                                    <td><?php printf("<a  href='index.php?action=editPharmacist&id=%s'><i class='fas fa-edit'></i></a>", $pharmacist['id'])?>
                                    </td>
                                    <td><?php printf("<a class='delete' href='index.php?action=deletePharmacist&id=%s'><i class='fas fa-trash'></i></a>", $pharmacist['id'])?>
                                    </td>
                                    <?php }?>
                                </tr>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <span style="font-weight: bold;margin-left: 5px; color:#4e73df">Age</span>
                                        <input type="date" name="age" placeholder="Age"
                                            value="<?php echo $pharmacist['age']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="date" name="date_of_employment" placeholder="date of employment"
                                            value="<?php echo $pharmacist['date_of_employment']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <i id="left" class="fa fa-regular fa-money-bill-1"></i>
                                        <input type="number" name="salary" placeholder="Salary"
                                            value="<?php echo $pharmacist['salary']; ?>" required>
                                    </label>
                                </div>
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <i id="left" class="fa-solid fa-id-card"></i>
                                        <input type="number" name="id_number" placeholder="ID Number"
                                            value="<?php echo $pharmacist['id_number']; ?>" required>
                                    </label>
                                </div>
...
$getSalesman = "SELECT * FROM salesmans";
    ...
    while ($salesman = mysqli_fetch_assoc($result)) {?>
                                ...
                                <tr>
                                    ...
                                    <td><?php printf("%s", clucDate($salesman['age']));?></td>
                                    <td><?php printf("%s", $salesman['date_of_employment']);?></td>
                                    <td><?php printf("%s", $salesman['salary']);?></td>
                                    <td><?php printf("%s", $salesman['id_number']);?></td>
                                    <?php if ('admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole) {?>
                                    <!-- For Admin, Manager, Pharmacist-->
                                    <td><?php printf("<a href='index.php?action=editSalesman&id=%s'><i class='fas fa-edit'></i></a>", $salesman['id'])?>
                                    </td>
                                    <td><?php printf("<a class='delete' href='index.php?action=deleteSalesman&id=%s'><i class='fas fa-trash'></i></a>", $salesman['id'])?>
                                    </td>
                                    <?php }?>
                                </tr>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <span style="font-weight: bold;margin-left: 5px; color:#4e73df">Age</span>
                                        <input type="date" name="age" placeholder="Age"
                                            value="<?php echo $salesman['age']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <input type="date" name="date_of_employment" placeholder="date of employment"
                                            value="<?php echo $salesman['date_of_employment']; ?>" required>
                                    </label>
                                </div>
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <i id="left" class="fa fa-regular fa-money-bill-1"></i>
                                        <input type="number" name="salary" placeholder="Salary"
                                            value="<?php echo $salesman['salary']; ?>" required>
                                    </label>
                                </div>
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <i id="left" class="fa-solid fa-id-card"></i>
                                        <input type="number" name="id_number" placeholder="ID Number"
                                            value="<?php echo $salesman['id_number']; ?>" required>
                                    </label>
                                </div>
